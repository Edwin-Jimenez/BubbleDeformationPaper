...
Response: \\
We agree that there are ``small'' differences between the previous
...
\par\noindent
Also we have made quantitative comparisons for the Taylor deformation
parameter $D$ in Table I (drop deformation) and our newly added Table II 
(bubble deformation).  Note that it took 8 months to compute the results
reported in our newly added Table II.  
