...
Response: \\
{\color{red}  
We have made a new figure (Figure 8: shear stress profile) for
the cases of 
(i) $Re$ = 50 and $Ca$ = 0.3, and
(ii) $Re$ = 93 and $Ca$ = 0.3.
Our new Figure 8 is a part of our new 
Section~I\hspace{-1.2pt}V.C.  The purpose of this new material
is to gain further insight on the unsteady dynamics of bubble
elongation.  What we discovered was that for the Reynolds
...
to one.  It is agreed, that the ``vacillating''
...
regardless of the outcome, we claim that one is assured of being within 
3 percent of the critical Reynolds number (see Figure 3).  In fact,
