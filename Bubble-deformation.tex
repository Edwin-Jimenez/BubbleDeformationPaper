...
dynamics in shear flow is also of critical importance for a variety of
scientific and engineering processes, particularly high performance plastics
applications that motivated this work.  In this article, we present
...
We validate our numerical methods through comparisons with previous
...
a function of the Capillary number $Ca$.  Although the $Re_{c}$ for drop
...
two-phase fluid flow is comprised of air and a viscous Newtonian liquid.  The
...
equation~\eqref{nseqn} is a body force due to surface tension and is equivalent
...
function using the height function technique.  We remark that we get the same
...
%
\begin{table}[tbh]
\caption{Shear-induced bubble breakup for various flow conditions described in terms
         of column pairs of critical Reynolds numbers and corresponding Capillary numbers.}
