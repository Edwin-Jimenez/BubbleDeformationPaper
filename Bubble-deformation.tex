...
%% (S/(n-m)) (X^T X)^{-1}
%% standard deviation: sqrt(2.1E-3)=.05 and sqrt(4.2E-3)=0.06
The predicted variances for the parameters 
``$4.9$'' and ``$-1.41$'' which appear in (\ref{bestfitraw}) are
$2.1E-3$ and $4.2E-3$ respectively.  In other words, even with just
...
\begin{figure}%[h!]
  ...
  \caption{A plot of the critical Reynolds number versus Capillary number
	...
	$2.1E-3$ and $4.2E-3$ respectively.  Even for the
